...
public class OdontologoJpaController implements Serializable {
    ...
    public void create(Odontologo odontologo) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findOdontologo(odontologo.getIdOdontologo()) != null) {
    ...
    public void edit(Odontologo odontologo) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                int id = odontologo.getIdOdontologo();
